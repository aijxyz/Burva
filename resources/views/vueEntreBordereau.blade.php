   ...
   <div class="row mt-5">
    ...
    <div class="card">
      ...
      <div class="table-responsive p-0">
        <table id="id_entrebord" class="table table-bordered table-striped  display ">
          <thead>
            <tr> 
          ...
          <tbody>
           @foreach($entreBordereaus as $entreBordereauscat)
           <tr>   
             <td class="text-center">{{$entreBordereauscat->id}}</td>              
             <td class="text-center">{{$entreBordereauscat->debutSerie}}</td>                        
             <td class="text-center">{{$entreBordereauscat->finSerie}}</td>     
             <td class="text-center">{{$entreBordereauscat->dateEntre}}</td>  
             <td class="text-center">{{$entreBordereauscat->prixUnitaire}}</td> 
             <td class="text-center">{{$entreBordereauscat->fournisseur->nom}}</td>
             <td class="text-center">{{$entreBordereauscat->prixTotal}}</td>                     
             <td class="text-center">  
              <button class="btn btn-info" data-toggle="modal"
              data-mydebut="{{$entreBordereauscat->debutSerie}}"
              data-myfin="{{$entreBordereauscat->finSerie}}"
              data-mydate="{{$entreBordereauscat->dateEntre}}"
              data-myprix="{{$entreBordereauscat->prixUnitaire}}"
              data-myprixtotal="{{$entreBordereauscat->prixTotal}}"
              data-myidfour="{{$entreBordereauscat->fournisseur->id}}"                         
              data-catid="{{$entreBordereauscat->id}}"
              data-target="#modifier">
              <i class="fa fa-edit"></i>
            </button>
            |                   
            <button class="btn btn-danger" data-toggle="modal" data-target="#supp" data-catid="{{$entreBordereauscat->id}}">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <form id="myForm" method="POST" action="{{route('entreBordereauAjout')}}">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <form id="myFormModif" method="POST" action="{{route('entreBordereauModifier')}}">
        {{method_field('patch')}} 
        {{csrf_field()}} 
        <div class="form-group row">                  
...
<input id="cat_id" type="hidden" name="entreBordereau_id" value=" " >  
</div> 
...
<div class="modal fade" id="supp" tabindex="-1" role="dialog" aria-labelledby="supplLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form method="POST" action="{{ route('entreBordereauSupp') }}">  
        {{method_field('delete')}}
        {{csrf_field()}}                             
        <div class="modal-body"> 
    ...
    $(document).ready(function(){ 
     ...
     /* var table = jQuery('#id_four').DataTable( {
      ...
      //id_four = jQuery('#id_four').DataTable();
          ...
          var table = $('#id_entrebord').DataTable( {
